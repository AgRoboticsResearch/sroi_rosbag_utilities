...
def main(data_folder):
    ...
    gripper_roi = 200  # D405: tags appear higher in frame
    tag_family = "tag16h5"
    left_gripper_tag_id = 0
    right_gripper_tag_id = 15
    norminal_diag_distance = 42  # D405: ~42px diagonal at typical distance
    threshold = 15  # D405: tighter threshold for smaller tags
